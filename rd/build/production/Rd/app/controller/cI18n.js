Ext.define('Rd.controller.cI18n', {
    ...
    models: ['mI18nMeta'],
    config: {
        urlCountryAdd   : '/cake2/rd_cake/countries/add',
        urlLanguageAdd  : '/cake2/rd_cake/phrase_values/add_language.json',
        urlKeyAdd       : '/cake2/rd_cake/phrase_values/add_key.json',
        urlCountryDel   : '/cake2/rd_cake/countries/delete.json',
        urlLanguageDel  : '/cake2/rd_cake/languages/delete.json',
        urlLanguageCopy : '/cake2/rd_cake/phrase_values/copy_phrases.json',
        urlPhpDel       : '/cake2/rd_cake/php_phrases/delete.json',
        urlPhpAdd       : '/cake2/rd_cake/php_phrases/add.json',
