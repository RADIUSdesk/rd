Ext.define('Rd.view.dynamicDetails.winDynamicDetailAddWizard', {
    extend:     'Ext.window.Window',
    alias :     'widget.winDynamicDetailAddWizard',
    closable:   true,
    draggable:  false,
    resizable:  false,
    ...
    mkScrnDynamicDetailDetail: function(){
        me = this;
        var frm = Ext.create('Rd.view.dynamicDetails.frmDetail',{itemId:'scrnDynamicDetailDetail', user_id: me.user_id, owner:me.owner, no_tree: true });
        return frm;
    },
