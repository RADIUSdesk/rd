Ext.define('Rd.controller.cDebug', {
    ...
    timeout: undefined,
    config: {
        urlFrStatusDb:      '/cake2/rd_cake/free_radius/status_debug.json',
        urlFrStartDb:       '/cake2/rd_cake/free_radius/start_debug.json',
        urlFrStopDb:        '/cake2/rd_cake/free_radius/stop_debug.json',
        urlFrTimeDb:        '/cake2/rd_cake/free_radius/time_debug.json',
        portWebSocket:      '8000'
    },
    refs: [
