...
//------------------------------------------------------------------------
    ...
    public function index(){
        ...
        foreach($q_r as $i){
            ...
            array_push($items,array(
                ...
                'last_value'            => $i['PermanentUserNotification']['last_value'],
    ...
    function _build_common_query($user){
        ...
        $sort   = 'PermanentUserNotification.last_notification';
        $dir    = 'DESC';
        ...
        if($user['group_name'] == Configure::read('group.ap')){  //AP
            ...
            foreach($this->parents as $i){
                ...
                if($i_id != $user_id){ //upstream
                    ...
                    array_push($tree_array,array('LicensedDevice.user_id' => $i_id));
                }
            }
